...
import app.moviedirectory.com.moviedirectory.Data.MovieRecyclerViewAdapter;
...
import app.moviedirectory.com.moviedirectory.Util.Prefs;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void showInputDialog(){
        ...
        final EditText input = (EditText) view.findViewById(R.id.edit_search);
    ...
    public List<Movie> getMovies(String searchItem){
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, Constants.URL_LEFT +
                searchItem + Constants.URL_MIDDLE + Constants.URL_RIGHT, new Response.Listener<JSONObject>() {
            @Override
